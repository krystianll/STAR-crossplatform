...
#ifdef STAR_GZ_INPUT
  #include "GzIfstream.h"
  typedef GzIfstream ReadInFstream;   // transparent plain/gz, streaming, all platforms
#else
  typedef std::ifstream ReadInFstream;
#endif
...
class InOutStreams {
    ...
    ReadInFstream readIn[MAX_N_MATES];
